...
(function(e, t, n, r) {
  ...
  Array.prototype.filter ||
    ...
    (t.Foundation = {
      ...
      init: function(t, n, r, i, s, o) {
        ...
        } else for (var c in this.libs) f.push(this.init_lib(c, a));
  ...
  (function(e, t, n, r) {
    ...
    Foundation.libs.alerts = {
      name: "alerts",
      version: "4.0.0",
      settings: { speed: 300, callback: function() {} },
      init: function(t, n, r) {
        return (
          (this.scope = t || this.scope),
      ...
      events: function() {
        var t = this;
        e(this.scope).on("click.fndtn.alerts", "[data-alert] a.close", function(
          n
        ) {
          n.preventDefault(),
            e(this)
  ...
  (function(e, t, n, r) {
    ...
    Foundation.libs.clearing = {
      ...
      events: function() {
        ...
        return (
          e(this.scope)
            .on("click.fndtn.clearing", "ul[data-clearing] li", function(
              t,
              r,
              i
            ) {
    ...
    Foundation.libs.dropdown = {
      ...
      css: function(n, r) {
        if (/body/i.test(n.offsetParent()[0].nodeName)) {
          var i = r.offset();
          (i.top -= n.offsetParent().offset().top),
            (i.left -= n.offsetParent().offset().left);
        } else var i = r.position();
        if (this.small())
          n.css({
            position: "absolute",
            width: "95%",
  ...
  (function(e, t, n, r) {
    ...
    Foundation.libs.forms = {
      ...
      assemble: function() {
        e('form.custom input[type="radio"]', e(this.scope))
          .not('[data-customforms="disabled"]')
          .each(this.append_custom_markup),
          e('form.custom input[type="checkbox"]', e(this.scope))
            .not('[data-customforms="disabled"]')
            .each(this.append_custom_markup),
      ...
      events: function() {
        var r = this;
        e(this.scope)
          .on("click.fndtn.forms", "form.custom span.custom.checkbox", function(
            t
          ) {
            t.preventDefault(), t.stopPropagation(), r.toggle_checkbox(e(this));
          })
          .on("click.fndtn.forms", "form.custom span.custom.radio", function(
            t
          ) {
          ...
          e(t).on("keydown", function(t) {
            ...
            if (s.length > 0) {
              t.preventDefault(),
                t.which === 13 && s.find("li.selected").trigger("click"),
                t.which === 27 && s.removeClass("open");
              if (t.which >= 65 && t.which <= 90) {
                var o = i.go_to(s, t.which),
                  u = s.find("li.selected");
                o &&
                  (u.removeClass("selected"),
                  i.scrollTo(o.addClass("selected"), 300));
              }
              if (t.which === 38) {
                var u = s.find("li.selected"),
                  a = u.prev(":not(.disabled)");
                a.length > 0 &&
                  ((a.parent()[0].scrollTop =
                    a.parent().scrollTop() - i.outerHeight(a)),
                  u.removeClass("selected"),
                  a.addClass("selected"));
              } else if (t.which === 40) {
                var u = s.find("li.selected"),
                ...
                o.length > 0 &&
                  ((o.parent()[0].scrollTop =
                    o.parent().scrollTop() + i.outerHeight(o)),
                  u.removeClass("selected"),
                  o.addClass("selected"));
              }
            }
      ...
      append_custom_markup: function(t, n) {
        ...
        r.parent().hasClass("switch") || r.addClass("hidden-field"),
          s.length === 0 &&
      ...
      append_custom_select: function(t, n) {
        ...
        if (s.length === 0) {
          ...
          (s = e(
            ...
            o.append(p),
            (v = s
              .prepend('<a href="#" class="current">' + l.html() + "</a>")
              .find(".current")),
            ...
            o.each(function(t) {
              this.selected &&
                (s
                  ...
                  .eq(t)
                  .addClass("selected"),
                s.find(".current").html(e(this).html())),
                e(this).is(":disabled") &&
                  s
                    .find("li")
                    .eq(t)
    ...
    Foundation.libs.joyride = {
          ...
          ? (this.settings.paused
            ...
            this.settings.$li.length && this.settings.$target.length > 0
              ? (t &&
                ...
                (this.settings.tipSettings.tipLocationPattern = this.settings.tipLocationPatterns[
      ...
      is_phone: function() {
        return Modernizr
          ? Modernizr.mq("only screen and (max-width: 767px)") ||
              e(".lt-ie9").length > 0
          : this.settings.$window.width() < 767;
      },
      hide: function() {
        ...
        if (!/body/i.test(this.settings.$target.selector)) {
          ...
          !this.visible(this.corners(this.settings.$next_tip)) &&
            ...
            (o
              ...
              .removeClass("right")
              .removeClass("left"),
            (this.settings.tipSettings.tipLocation = this.settings.tipSettings.tipLocationPattern[
              this.settings.attempts
            ]),
            this.settings.attempts++,
            this.pos_default());
      ...
      expose: function() {
        var n,
          ...
          i,
          s,
          o = "expose-" + Math.floor(Math.random() * 1e4);
    ...
    (Foundation.libs = Foundation.libs || {}),
      (Foundation.libs.orbit = {
        ...
        _bullets_container_html: function(t) {
          var n = this,
            r = e(
              '<ol class="' + n.settings.bullets_container_class + '"></ol>'
            );
          return (
            t.each(function(t, i) {
              var s = e(
                '<li data-orbit-slide-number="' + (t + 1) + '" class=""></li>'
              );
              t === 0 && s.addClass(n.settings.bullets_active_class),
                r.append(s);
            }),
            r
          );
        ...
        _slide_number_html: function(t, n) {
          ...
          return (
            i.append("<span>" + t + "</span> of <span>" + n + "</span>"), i
          );
        },
        _timer_html: function() {
          var e = this;
          return typeof e.settings.timer_speed == "number" &&
            e.settings.timer_speed > 0
            ? '<div class="' +
                e.settings.timer_container_class +
                '"><span></span><div class="' +
                e.settings.timer_progress_class +
                '"></div></div>'
            : "";
        },
        _next_html: function() {
        ...
        _init: function(t, n) {
          var r = this,
            ...
            o = i.children();
          e.extend(!0, r.settings, r.data_options(i)),
            r.settings.navigation_arrows &&
              (s.append(r._prev_html()), s.append(r._next_html())),
            i.addClass(r.settings.slides_container_class),
            r.settings.stack_on_small &&
              s.addClass(r.settings.stack_on_small_class),
            r.settings.slide_number &&
              s.append(r._slide_number_html(1, o.length)),
            s.append(r._timer_html()),
            r.settings.bullets && s.after(r._bullets_container_html(o)),
            i.append(
              o
                .first()
                .clone()
            ...
            i.css("marginLeft", "-100%"),
            o.first().addClass(r.settings.active_slide_class),
            r._init_events(i),
            r._init_dimensions(i),
            r._start_timer(i);
        },
        _init_events: function(i) {
          ...
          e(t)
            .on("load.fndtn.orbit", function() {
              i.height(""),
                i.height(i.height(o.height())),
                i.trigger("orbit:ready");
            })
            ...
            e(n).on("click.fndtn.orbit", "[data-orbit-link]", function(t) {
              ...
              r.length === 1 &&
                (s._reset_timer(i, !0), s._goto(i, r.index(), function() {}));
            }),
            o
              .siblings("." + s.settings.bullets_container_class)
              .on("click.fndtn.orbit", "[data-orbit-slide-number]", function(
                t
              ) {
                t.preventDefault(),
                  s._reset_timer(i, !0),
                  s._goto(
                    i,
                    e(t.currentTarget).data("orbit-slide-number"),
                    function() {}
                  );
              }),
            o
              .on("orbit:after-slide-change.fndtn.orbit", function(e, t) {
                ...
                n.length === 1 &&
                  n.replaceWith(
                    s._slide_number_html(t.slide_number, t.total_slides)
                  );
              })
              .on(
                "orbit:next-slide.fndtn.orbit click.fndtn.orbit",
                "." + s.settings.next_class,
                function(e) {
                  e.preventDefault(),
                    s._reset_timer(i, !0),
                    s._goto(i, "next", function() {});
                }
              )
              .on(
                "orbit:prev-slide.fndtn.orbit click.fndtn.orbit",
                "." + s.settings.prev_class,
                function(e) {
                  e.preventDefault(),
                    s._reset_timer(i, !0),
                    s._goto(i, "prev", function() {});
                }
              )
              .on(
                ...
                function(t) {
                  t.preventDefault();
                  var n = e(t.currentTarget).toggleClass(
                      s.settings.timer_paused_class
                    ),
                    r = n
                      .closest("." + s.settings.container_class)
                      .find("." + s.settings.slides_container_class);
                  n.hasClass(s.settings.timer_paused_class)
                    ? s._stop_timer(r)
                    : s._start_timer(r);
                }
              )
        ...
        _init_dimensions: function(e) {
          var t = e.parent(),
            n = e.children();
          e.css("width", n.length * 100 + "%"),
            n.css("width", 100 / n.length + "%"),
            e.height(t.height()),
            e.css("width", n.length * 100 + "%");
        },
        _start_timer: function(e) {
          ...
          s.animate({ width: "100%" }, u, "linear", r),
        ...
        _stop_timer: function(e) {
          var t = this,
            ...
            s = i.width() / r.width();
          t._rebuild_timer(n, s * 100 + "%"),
            e.trigger("orbit:timer-stopped"),
            (r = n.find("." + t.settings.timer_container_class)),
            r.addClass(t.settings.timer_paused_class);
        },
        ...
        _goto: function(t, n, r) {
          ...
          n === "prev"
            ...
            : n === "next"
            ? (a = (a + 1) % o.length)
            : typeof n == "number" && (a = n % o.length),
            a === o.length - 1 && n === "next"
              ? (t.css(f, "0%"), (a = 1))
              : a === 0 &&
                n === "prev" &&
                (t.css(f, "-" + (o.length - 1) * 100 + "%"),
                (a = o.length - 2)),
            s.addClass(i.settings.orbit_transition_class),
            u.removeClass(i.settings.active_slide_class),
            e(o[a]).addClass(i.settings.active_slide_class);
          var l = s.siblings("." + i.settings.bullets_container_class);
          l.length === 1 &&
            (l.children().removeClass(i.settings.bullets_active_class),
            e(l.children()[a - 1]).addClass(i.settings.bullets_active_class));
          var c = "-" + a * 100 + "%";
          t.trigger("orbit:before-slide-change");
          if (t.css(f) === c)
            s.removeClass(i.settings.orbit_transition_class),
              t.trigger("orbit:after-slide-change", [
                { slide_number: a, total_slides: t.children().length - 2 }
              ]),
              r();
          else {
            var h = {};
            (h[f] = c),
              t.animate(h, i.settings.animation_speed, "linear", function() {
                s.removeClass(i.settings.orbit_transition_class),
                  t.trigger("orbit:after-slide-change", [
                    { slide_number: a, total_slides: t.children().length - 2 }
                  ]),
    ...
    Foundation.libs.reveal = {
        ...
        return (
          e(this.scope)
            ...
            .on("click.fndtn.reveal", "[data-reveal-id]", function(n) {
              n.preventDefault(),
                t.locked || ((t.locked = !0), t.open.call(t, e(this)));
            })
            .on(
              "click.fndtn.reveal touchend.click.fndtn.reveal",
              this.close_targets(),
              function(n) {
                n.preventDefault();
                if (!t.locked) {
                  ...
                  if (
                    e(n.target)[0] === e("." + r.bgClass)[0] &&
                    !r.closeOnBackgroundClick
                  )
                    return;
                  (t.locked = !0),
      ...
      open: function(t) {
        ...
        if (!n.hasClass("open")) {
          ...
          typeof n.data("css-top") == "undefined" &&
            n
              .data("css-top", parseInt(n.css("top"), 10))
              .data("offset", this.cache_offset(n)),
            n.trigger("open"),
            r.length < 1 && this.toggle_bg(n),
            this.hide(r, this.settings.css.close),
      ...
      open_video: function(t) {
        ...
        if (r.length > 0) {
          ...
          typeof i == "string" && (r[0].src = r.attr("data-src")),
            n.show().fadeIn(100);
        }
      },
  ...
  (function(e, t, n, r) {
    ...
    Foundation.libs.section = {
      ...
      settings: {
        ...
        active_region_selector:
          "section.active, .section.active, .active[data-section-region]",
      ...
      init: function(t, n, r) {
        ...
        return (
          ...
          typeof n == "object" && e.extend(!0, i.settings, n),
          typeof n != "string"
            ? (this.set_active_from_hash(), this.events(), !0)
            : this[n].call(this, r)
        );
      },
      events: function() {
        ...
        e(this.scope).on(
          "click.fndtn.section",
          "[data-section] .title, [data-section] [data-section-title]",
          function(t) {
            var n = e(this),
          ...
          e(t)
            ...
            .on("hashchange", function() {
              r.settings.toggled ||
                (r.set_active_from_hash(), e(this).trigger("resize"));
            })
            .trigger("resize"),
          e(n).on("click.fndtn.section", function(t) {
            e(t.target).closest(r.settings.title_selector).length < 1 &&
              e(r.settings.nav_selector)
      ...
      toggle_active: function(t, n) {
        ...
        (n.settings.toggled = !0),
          !u.deep_linking && s.length > 0 && t.preventDefault();
        if (i.hasClass("active"))
          (n.small(o) ||
            n.is_vertical_nav(o) ||
            n.is_horizontal_nav(o) ||
            n.is_accordion(o)) &&
            (a[0] !== i[0] || (a[0] === i[0] && !u.one_up)) &&
            i.removeClass("active").attr("style", "");
        else {
          ...
          if (n.small(o) || u.one_up)
            n.small(o)
              ...
              : a.attr(
                  "style",
                  "visibility: hidden; padding-top: " + f + "px;"
                );
          n.small(o) ? i.attr("style", "") : i.css("padding-top", f),
            i.addClass("active"),
            a.length > 0 && a.removeClass("active").attr("style", ""),
            n.is_vertical_tabs(o) &&
              (s.css("display", "block"),
              a !== null &&
                a.children(n.settings.content_selector).css("display", "none"));
        }
        setTimeout(function() {
      ...
      resize: function() {
        ...
        n.each(function() {
          ...
          if (r.length > 1)
            ...
            r.length < 1 &&
            !t.is_vertical_nav(n) &&
            !t.is_horizontal_nav(n) &&
            !t.is_accordion(n)
          ) {
            var s = n.children(t.settings.region_selector).first();
            (i.one_up || !t.small(n)) && s.addClass("active"),
              t.small(n)
                ? s.attr("style", "")
                : s.css(
                    "padding-top",
                    t.outerHeight(s.children(t.settings.title_selector))
                  );
          }
          t.small(n)
            ? r.attr("style", "")
            : r.css(
                "padding-top",
                t.outerHeight(r.children(t.settings.title_selector))
              ),
            t.position_titles(n),
            (t.is_horizontal_nav(n) && !t.small(n)) || t.is_vertical_tabs(n)
              ? t.position_content(n)
              : t.position_content(n, !1);
        });
      },
      ...
      set_active_from_hash: function() {
        ...
        r.each(function() {
          ...
          if (n.length > 0 && r.deep_linking) {
            var s = t
              .children(i.settings.region_selector)
              .attr("style", "")
              .removeClass("active");
            s.map(function() {
              return e(this).children(
                '.content[data-slug="' +
                  n +
                  '"], [data-section-content][data-slug="' +
                  n +
                  '"]'
              );
            })
      ...
      position_titles: function(t, n) {
        ...
        typeof n == "boolean"
          ? i.attr("style", "")
          : i.each(function() {
              r.is_vertical_tabs(t)
                ? (e(this).css("top", o), (o += r.outerHeight(e(this))))
                : (r.rtl ? e(this).css("right", s) : e(this).css("left", s),
                  (s += r.outerWidth(e(this))));
            });
      },
        ...
        if (typeof n == "boolean") o.attr("style", ""), t.attr("style", "");
          ...
          i.each(function() {
            ...
            (f = r.outerWidth(i)),
              ...
              o < a && (a = o),
              (u += r.outerHeight(i)),
              e(this).hasClass("active") || s.css("display", "none");
          }),
            i.each(function() {
          ...
          i.each(function() {
            ...
            typeof Zepto == "function"
              ? t.height(this.outerHeight(s.first()))
              : t.height(this.outerHeight(s.first()) - 2);
      },
        ...
        Modernizr.touch
          ? e(this.scope)
              .on(
                ...
                function(t) {
                  t.preventDefault(),
                    e(i.settings.tooltipClass).hide(),
          ...
          : e(this.scope).on(
              ...
              function(t) {
                var n = e(this);
                t.type === "mouseover" || t.type === "mouseenter"
                  ? i.showOrCreateTip(n)
  ...
  (function(e, t, n, r) {
    ...
    Foundation.libs.topbar = {
      ...
      init: function(n, r, i) {
        var s = this;
        return (
          typeof r == "object" && e.extend(!0, this.settings, r),
          typeof r != "string"
            ? (e(".top-bar").each(function() {
                (s.settings.$w = e(t)),
                ...
                var n = e("<div class='top-bar-js-breakpoint'/>").insertAfter(
                  s.settings.$topbar
                );
      ...
      events: function() {
        ...
        e(this.scope)
          .on("click.fndtn.topbar", ".top-bar .toggle-topbar", function(i) {
            var s = e(this).closest(".top-bar"),
              o = s.find("section, .section"),
              u = s.children("ul").first();
            s.data("height") || n.largestUL(),
              i.preventDefault(),
              n.breakpoint() && s.toggleClass("expanded").css("min-height", ""),
              s.hasClass("expanded")
                ...
                : (n.rtl
                    ? (o.css({ right: "0%" }),
                      o.find(">.name").css({ right: "100%" }))
                    : (o.css({ left: "0%" }),
                      o.find(">.name").css({ left: "100%" })),
          ...
          .on("click.fndtn.topbar", ".top-bar .has-dropdown>a", function(t) {
            ...
            if (n.breakpoint()) {
              var u = e(this),
                a = u.closest("li");
              r.data("index", r.data("index") + 1),
                a.addClass("moved"),
                n.rtl
                  ? (i.css({ right: -(100 * r.data("index")) + "%" }),
                    i
                      .find(">.name")
                      .css({ right: 100 * r.data("index") + "%" }))
                  : (i.css({ left: -(100 * r.data("index")) + "%" }),
                    i
                      .find(">.name")
                      .css({ left: 100 * r.data("index") + "%" })),
                e(".top-bar").css("min-height", o),
                u
                  .siblings("ul")
                  .height(r.data("height") + n.outerHeight(s, !0)),
                r.css(
                  "min-height",
                  r.data("height") + n.outerHeight(s, !0) * 2
                );
            }
          }),
          e(t).on(
          ...
          e(this.scope).on(
            ...
            function(t) {
              ...
              i.data("index", i.data("index") - 1),
                ...
                i.data("index") === 0 && i.css("min-height", 0),
                setTimeout(function() {
                  o.removeClass("moved");
                }, 300);
            }
      ...
      breakpoint: function() {
        return (
          e(t).width() <= this.settings.breakPoint ||
          e("html").hasClass("lt-ie9")
        );
      },
      assemble: function() {
        ...
        this.settings.$section.detach(),
          this.settings.$section.find(".has-dropdown>a").each(function() {
            ...
            t.settings.custom_back_text == 1
              ? i.find("h5>a").html("&laquo; " + t.settings.back_text)
              : i.find("h5>a").html("&laquo; " + n.html()),
              r.prepend(i);
          }),
      ...
      sticky: function() {
        ...
        if (e(n).length > 0) {
          ...
          i.scroll(function() {
            i.scrollTop() >= r
              ? (e(n).addClass("fixed"), e("body").css("padding-top", s))
              : i.scrollTop() < r &&
                (e(n).removeClass("fixed"), e("body").css("padding-top", "0"));
          });
        }
      },
      off: function() {
