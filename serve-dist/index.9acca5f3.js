...
})({"3JLd4":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "a5a337b49acca5f3";
"use strict";
...
var _sampleDefault = parcelHelpers.interopDefault(_sample);
var _appCss = require("./App.css");
var _nodeCss = require("./Node.css");
...
const handleMouseMove = _throttleDefault.default((e)=>{
    const MX = e.pageX;
    const MY = e.pageY;
    const topAngle = 90;
    ...
    let position = "";
    if (MH < 0 && HC < 0) position = "top-left";
    if (MH >= 0 && HC < 0) position = "bottom-left";
    if (MH < 0 && HC >= 0) position = "top-right";
    if (MH >= 0 && HC >= 0) position = "bottom-right";
    let TCL = TCL_RAW;
    switch(position){
        case "top-left":
            TCL = -TCL_RAW;
...
const animateTheme = ()=>{
    const theme = _sampleDefault.default(themeList) ?? "green";
...
},{"lodash/throttle":"27ZiF","lodash/sample":"l4wxB","./App.css":"l08wk","./Node.css":"6o7eW","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"27ZiF":[function(require,module,exports) {
...
},{"./debounce":"c0Kjd","./isObject":"euXL6"}],"c0Kjd":[function(require,module,exports) {
...
},{"./isObject":"euXL6","./now":"h0DPI","./toNumber":"fGewd"}],"euXL6":[function(require,module,exports) {
/**
...
},{}],"h0DPI":[function(require,module,exports) {
...
},{}],"fGewd":[function(require,module,exports) {
...
},{"./_root":"11IUn"}],"dGPaO":[function(require,module,exports) {
...
},{}],"l4wxB":[function(require,module,exports) {
var arraySample = require('./_arraySample'), baseSample = require('./_baseSample'), isArray = require('./isArray');
/**
...
},{"./_arraySample":"auC7o","./_baseSample":"iR3af","./isArray":"kFpV8"}],"auC7o":[function(require,module,exports) {
...
},{"./_baseRandom":"cH6aw"}],"cH6aw":[function(require,module,exports) {
...
},{}],"iR3af":[function(require,module,exports) {
var arraySample = require('./_arraySample'), values = require('./values');
/**
...
},{"./_arraySample":"auC7o","./values":"fyiRk"}],"fyiRk":[function(require,module,exports) {
...
},{"./_baseValues":"j0i92","./keys":"5kkas"}],"j0i92":[function(require,module,exports) {
...
},{"./_arrayMap":"62kux"}],"62kux":[function(require,module,exports) {
/**
...
},{"./_baseGetTag":"0i2U0","./isObjectLike":"fDYnb"}],"kFpV8":[function(require,module,exports) {
/**
...
},{}],"cM06B":[function(require,module,exports) {
...
},{"./isFunction":"hgsN6","./isLength":"g0eIg"}],"hgsN6":[function(require,module,exports) {
...
},{"./_baseGetTag":"0i2U0","./isObject":"euXL6"}],"l08wk":[function() {},{}],"6o7eW":[function() {},{}],"ciiiV":[function(require,module,exports) {
...
},{}]},["3JLd4","Yx9M4"], "Yx9M4", "parcelRequire2e73")

//# sourceMappingURL=index.9acca5f3.js.map
